 ...
 */
namespace Drc\Mobileapp\Model\Cart;
...
class CartTotalRepository implements CartTotalRepositoryInterface
{
    ...
    public function get($cartId)
    {
        ...
        $quoteTotals->setBaseCurrencyCode(__($this->storeManager->getStore()->getCurrentCurrency()->getCode()));
        $quoteTotals->setQuoteCurrencyCode(__($this->storeManager->getStore()->getCurrentCurrency()->getCode()));
        return $quoteTotals;
    }
}
