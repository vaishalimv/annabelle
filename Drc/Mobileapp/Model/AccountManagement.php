...
class AccountManagement 
{
     ...
     * {@inheritdoc}
     */
    public function createAccount(CustomerInterface $customer, $password = null, $redirectUrl = '', $devicetype, $devicetoken, $deviceid)
    {
        if ($password !== null) {
        ...
        return $this->createAccountWithPasswordHash($customer, $hash, $redirectUrl, $devicetype, $devicetoken, $deviceid);
    }
     ...
     */
    public function createAccountWithPasswordHash(CustomerInterface $customer, $hash, $redirectUrl = '', $devicetype, $devicetoken, $deviceid)
    {
